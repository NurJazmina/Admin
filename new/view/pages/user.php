	...
	<div class="offcanvas-header d-flex align-items-center justify-content-between pb-5" kt-hidden-height="40" style="">
		...
		<a href="index.php?page=dashboard" class="btn btn-xs btn-icon btn-light btn-hover-primary" id="kt_quick_user_close">
	...
	<div class="offcanvas-content pr-5 mr-n5 scroll" style="height: auto; overflow: hidden;">
		...
		<div class="d-flex align-items-center mt-5">
			...
			<div class="d-flex flex-column">
				...
				<div class="navi mt-2">
					...
					<a href="model/logout.php" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Sign Out</a>
				</div>
			</div>
		</div>
		<!--end::Header-->
		...
		<div class="navi navi-spacer-x-0 p-0">
			<!--begin::Item-->
			<a href="index.php?page=profile" class="navi-item">
				<div class="navi-link">

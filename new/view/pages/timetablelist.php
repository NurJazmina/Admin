        ...
        <div class="col-12 col-sm-12 col-sm-12">
              <form name="searchschool" class="form-inline" action="index.php?page=timetablelist" method="post">
                <div class="col-12 col-sm-12 col-lg-12 text-right">
                  <div class="row">
                    <button type="button" style="width:25%; color:#FFFFFF;" class="btn btn-info font-weight-bolder btn-sm"" data-bs-toggle="modal" data-bs-target="#recheckaddtimetable" >Add</button>
                    ...
                    <button type="submit" style="width:25%; color:#FFFFFF;" class="btn btn-info font-weight-bolder btn-sm"" name="teacherid" >Search</button>
                  </div>
                </div>
              </form>
        </div>

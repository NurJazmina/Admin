    ...
    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
        ...
        <ul class="navi flex-column navi-hover py-2">
            ...
            foreach ($cursor as $document)
            {
                ...
                ?>
                <li class="navi-item">
                    <a href="index.php?page=departmentinfo&department=<?php echo $DepartmentId; ?>&departmentname=<?php echo $DepartmentName; ?>" class="navi-link">
                        <span class="navi-icon">
              ...
              <tbody>
                <tr>
                  ...
                  <?php
                    ...
                    {
                        $filter = ['SchoolID'=>$_SESSION["loggeduser_schoolID"], 'Staffdepartment'=>$_GET['department']];
                        $query = new MongoDB\Driver\Query($filter);
                        $cursor = $GoNGetzDatabase->executeQuery('GoNGetzSmartSchool.Staff',$query);
                        $totalstaff = 0;
                    }
                            ...
                            <div class="tab-pane fade show active" id="active" role="tabpanel" aria-labelledby="active-tab">
                              <div class="table-responsive">
                                ...
                                <?php
                                    ...
                                    $filter2 = ['department_id'=>$_GET['department'],'SubRemarks'=>'0','departmentRemarksStatus'=>'ACTIVE'];

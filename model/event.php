...
if (isset($_POST['add_event'])) 
{
  ...
  // prevent web attacks from input text
  ...
  try
  {
    $result =$GoNGetzDatabase->executeBulkWrite('GoNGetzSmartSchool.Event', $bulk, $writeConcern);
  }
                                ...
                                <tr>
                                  <td style='font-family: sans-serif; font-size: 14px; vertical-align: top;'>
                                    <p style='font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;'> 
                                      ...
                                      <p>Here's the latest Event <a href='https://smartschool.gongetz.com/profile.php?id=$ConsumerIDNo'> $title </a> from $FromNameF $FromNameL on $date and we thought it might need your attention.</p>
                                      <p>Thanks,<br/>
                                      <p>Go N Getz</p>

<?php $_SESSION["title"] = "Department Detail"; ?>
<!--begin::Content-->
...
<div><br><h1 style="color:#696969; text-align:center">Department Info</h1></div><br>
<div class="row" >
                    ...
                    <div class="tab-pane fade show active" id="active" role="tabpanel" aria-labelledby="active-tab">
                      ...
                      foreach ($cursor2 as $document2)
                      {
                        ...
                        ?>
                          ...
                          <?php 
                          $filter4 = ['department_id'=>$_GET['id'],'SubRemarks'=>$remarkid1,'departmentRemarksStatus'=>'ACTIVE'];
                          ...
                          foreach ($cursor4 as $document4)
                          {
                            ...
                            <form name="AddDepartmentRemarkChildFormSubmit" action="model/adddepartmentremarkchild.php" method="POST">
                              <div class="row">
                              <div class="col">
                                <textarea class="department" name="txtconsumerRemark" rows="3"></textarea>
                                <br>
                                <div class="row">
                                <div class="col text-right">
                    ...
                    <div class="table-responsive">
                      ...
                      foreach ($cursor2 as $document2)
                      {
                        ...
                        ?>
                          ...
                          <?php 
                          $filter4 = ['department_id'=>$_GET['id'],'SubRemarks'=>$remarkid1,'departmentRemarksStatus'=>'PENDING'];
                          $option4 = ['sort' => ['_id' => -1],'limit'=>10];
                          $query4 = new MongoDB\Driver\Query($filter4, $option4);
                          $cursor4 = $GoNGetzDatabase->executeQuery('GoNGetzSmartSchool.DepartmentRemarks',$query4);
                          foreach ($cursor4 as $document4)
                    ...
                    <div class="table-responsive">
                      ...
                      foreach ($cursor2 as $document2)
                      {
                        ...
                        ?>
                          ...
                          <div  id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                          <?php 
                          $filter4 = ['department_id'=>$_GET['id'],'SubRemarks'=>$remarkid1,'departmentRemarksStatus'=>'COMPLETED'];
                          $option4 = ['sort' => ['_id' => -1],'limit'=>10];
                          $query4 = new MongoDB\Driver\Query($filter4, $option4);
                          $cursor4 = $GoNGetzDatabase->executeQuery('GoNGetzSmartSchool.DepartmentRemarks',$query4);
                          foreach ($cursor4 as $document4)
...
{
  ?>
    <div><h1 style="color:#696969; text-align:center">Department Info</h1></div><br>
  <?php
}
?>

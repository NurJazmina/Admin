    ...
    <div class="modal-content">
        ...
        <form id="mail"  name="mail" action="index.php?page=mail" method="post">
            ...
            <div class="d-block">
                ...
                <!--end::To-->
                <!--begin::CC-->
                <div class="d-flex align-items-center border-bottom inbox-to-cc pl-8 pr-5 min-h-45px">
                ...
                <!--end::CC-->
                <!--begin::BCC-->
                <div class="d-flex align-items-center border-bottom inbox-to-bcc pl-8 pr-5 min-h-45px">
                    <div class="text-dark-50 w-75px">Bcc:</div>
                    <div class="flex-grow-1" >
                        <select class="form-control" name="compose_Bcc" >

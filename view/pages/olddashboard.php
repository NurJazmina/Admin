				...
				<div class="row">
					<div class="col-xxl-6">
						...
						<div class="text-center pb-7 pb-xxl-1">
							<button class="btn btn-success font-weight-bolder font-size-sm py-3 px-9" id="kt_app_education_more_feeds_btn">More Feeds</button>
						</div>
					</div>
					<div class="col-xxl-6">
									...
									<div class="tab-pane fade show active" id="kt_tab_pane_7_2" role="tabpanel" aria-labelledby="kt_tab_pane_7_2">
										...
										<form class="form" id="kt_form_7_2">
											...
											<div class="text-right">
												<button class="btn btn-success btn-block font-weight-bold">Send Report</button>
											</div>
										</form>
										<!--end::Form-->
									</div>

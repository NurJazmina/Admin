...
if (isset($_POST['recheck_add_student']))
{
  ...
  $filter = ['ConsumerIDNo'=>$student_consumer_idno,'ConsumerGroup_id'=>'6018c32b10184a751c102eb6'];
  ...
  foreach ($cursor as $document)
  {
    ...
    foreach ($cursor as $document2)
    {
      ...
      if($ConsumerGroup_id == '6018c2ebc8c7c7b2e8a4140c' || $ConsumerGroup_id == '601b4cfd97728c027c01f187')
      {
        ...
        if ($consumer_id == $ParentConsumerid)
        {
          //parent already exist
          if($studentid == '')
          {
              ...
              <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    <input type="hidden" name="parent_consumer_idno" value="<?= $parent_consumer_idno; ?>">
                    <input type="hidden" name="student_consumer_idno" value="<?= $student_consumer_idno; ?>">
                    ...
                    <button name="add_relation_student" type="submit" class="btn btn-success">Proceed</a>
                  </div>
                </div>
              </div>
            </form>
              ...
              <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    ...
                    <input type="hidden" name="class_category" value="<?= $class_category; ?>
                    <button onclick="index.php?page=studentlist" class="btn btn-light btn-sm">return</button>
                    <button name="duplicate_add_relation" type="submit" class="btn btn-success">Proceed</a>
                  </div>
                </div>
              </div>
            </form>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input class="form-control" value="<?=  $parent_consumer_idno; ?>" disabled><br>
                          <input type="hidden" name="txtConsumerIDNoParent" value="<?=  $parent_consumer_idno; ?>" >
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input class="form-control" value="<?=  $student_consumer_idno; ?>" disabled><br>
                          <input type="hidden" name="txtConsumerIDNoChild" value="<?=  $student_consumer_idno; ?>">
                        </div>
                      </div>
                      <div class="form-group row">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input class="form-control" value="<?= $parent_consumer_idno; ?>" disabled>
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-sm-2 col-form-label">Group</label>

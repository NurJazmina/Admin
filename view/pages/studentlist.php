                ...
                <div class="col-12 col-sm-12 col-lg-12 text-right">
                  ...
                  if($_SESSION["loggeduser_ACCESS"] =='STAFF') 
                  {
                    ?>
                      ...
                      <button type="button" style="width:15%;" class="btn btn-success font-weight-bolder btn-sm" data-bs-toggle="modal" data-bs-target="#recheckaddstudent" >Add</button>
                ...
                foreach ($cursor as $document)
                {
                  ...
                  foreach ($cursor1 as $document1)
                  {
                    ...
                    <tr>
                      ...
                      <table class="table table-sm bg-light" width="50%" cellspacing="0" style= "text-align: center;">
                      <td>
                      <table>
                      <tr>
                      <?php
                      ...
                      {
                      ?>
                      <button type="button" style="font-size:15px width:25%" class="btn btn-success btn-sm"><a class="text-white" href="index.php?page=exportstudentattendance&id=<?php echo $consumerid; ?>">more >></a></button>
                      <?php
                      }
                      ?>
                      </td>
                      ...
                      {
                        ?>
                        <button style="font-size:10px" type="button" class="btn btn-light btn-hover-success btn-sm" data-bs-toggle="modal" data-bs-target="#recheckeditstudent" data-bs-whatever="<?php echo $Consumer_id; ?>">
                      ...
                      {
                        ?>
                        <button style="font-size:10px" type="button" class="btn btn-light btn-hover-success btn-sm" data-bs-toggle="modal" data-bs-target="#StatusStudentModal" data-bs-whatever="<?php echo $Consumer_id; ?>">

...
<div class="content d-flex flex-column flex-column-fluid">
    <div class="px-10">
        <div class="row">
            ...
            <div class="col-sm text-right">
                ...
                <button type="submit" class="btn btn-success" name="editing">Turn Editing On</button>
            </div>
        </div>
    </div>
    <br>
    <div class="card card-custom gutter-b px-5">
        <div class="card-body">
            <div class="row">
                <div class="col-sm">
                    <h3  id="section0" contenteditable="true">Welcome !!
                        <a type="button" class="btn btn-sm"  onclick="myFunction(this);">

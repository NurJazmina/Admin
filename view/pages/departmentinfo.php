				...
				<div class="card card-custom">
					...
					<div class="card-header py-3">
						<div class="card-title align-items-start flex-column">
							<h3 class="card-label font-weight-bolder text-dark"><?php echo $DepartmentName; ?></h3>
						</div>
					</div>
					<!--end::Header-->
					<div class="row" >
													...
													<div class="card-body">
														...
														<div class="tab-content" id="v-pills-tabContent">
															...
															<div class="box">
																...
																<div class="row">
																<div class="col">
																	<textarea class="departmentinfo" name="txtdepartmentRemark" rows="3"></textarea>
																	<br>
																	<div class="row">
																...
																<div class="tab-pane fade show active" id="active" role="tabpanel" aria-labelledby="active-tab">
																	...
																	?>
																		...
																		foreach ($cursor4 as $document4)
																		{
																			...
																			<div class="row">
																			<div class="col">
																				<textarea class="departmentinfo" name="txtconsumerRemark" rows="3"></textarea>
																				<br>
																				<div class="row">
																				<div class="col text-right">
							...
							<div class="col-sm">
								<div class="row py-5">
									...
									?>
										...
										<button type="button" style="font-size:15px width:25%" class="btn btn-success"><a href="index.php?page=departmentinfo&attendance=<?php echo "xls"; ?>" tabindex="-1" data-type="alpha" style="color:#FFFFFF; text-decoration: none;">EXPORT ATTENDANCE TO XLS</a></button>
									<?php

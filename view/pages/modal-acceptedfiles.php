<div class="modal-content" id="yui_3_17_2_1_1624346687730_1631">
            ...
            <div class="modal-body" data-region="body" style="" id="yui_3_17_2_1_1624346687730_1619"><div data-filetypesbrowserbody="id_assignsubmission_file_filetypes" role="tree">
    <div data-filetypesbrowserkey="*" role="treeitem" aria-expanded="false">
        <label>
            <input data-filetypesbrowserkey="*" type="checkbox">
            <strong data-filetypesname="*">All file types</strong>
            <small class="muted" data-filetypesextensions="*">
    ...
    <div data-filetypesbrowserkey="archive" role="treeitem" aria-expanded="false">
        <label>
            <input data-filetypesbrowserkey="archive" type="checkbox">
            <strong data-filetypesname="archive">Archive files</strong>
            <small class="muted" data-filetypesextensions="archive">
                .7z .bdoc .cdoc .ddoc .gtar .tgz .gz .gzip .hqx .rar .sit .tar .zip
            </small>
        </label>
        
        <small aria-hidden="true" data-filetypesbrowserfeature="hideifexpanded" class="float-right float-right"><a href="#">Expand</a></small>
        <small aria-hidden="true" data-filetypesbrowserfeature="hideifcollapsed" class="float-right float-right"><a href="#">Collapse</a></small>
        <ul class="unstyled list-unstyled" role="group">
            <li data-filetypesbrowserkey=".bdoc" style="margin-left: 2em" role="treeitem">
                <label>
                    <input data-filetypesbrowserkey=".bdoc" type="checkbox">
                    <span data-filetypesname=".bdoc">application/x-digidoc</span>
                    <small class="muted" data-filetypesextensions=".bdoc">
                        .bdoc
                    </small>
                </label>
            </li>
            <li data-filetypesbrowserkey=".cdoc" style="margin-left: 2em" role="treeitem">
                <label>
                    <input data-filetypesbrowserkey=".cdoc" type="checkbox">
                    <span data-filetypesname=".cdoc">application/x-digidoc</span>
                    <small class="muted" data-filetypesextensions=".cdoc">
                        .cdoc
                    </small>
                </label>
            </li>
            <li data-filetypesbrowserkey=".ddoc" style="margin-left: 2em" role="treeitem">
                <label>
                    <input data-filetypesbrowserkey=".ddoc" type="checkbox">
                    <span data-filetypesname=".ddoc">application/x-digidoc</span>
                    <small class="muted" data-filetypesextensions=".ddoc">
                        .ddoc
                    </small>
                </label>
            </li>
            <li data-filetypesbrowserkey=".7z" style="margin-left: 2em" role="treeitem">
                <label>
                    <input data-filetypesbrowserkey=".7z" type="checkbox">
                    <span data-filetypesname=".7z">Archive (7Z)</span>
                    <small class="muted" data-filetypesextensions=".7z">
                        .7z
                    </small>
                </label>
            </li>
            <li data-filetypesbrowserkey=".gtar" style="margin-left: 2em" role="treeitem">
                <label>
                    <input data-filetypesbrowserkey=".gtar" type="checkbox">
                    <span data-filetypesname=".gtar">Archive (GTAR)</span>
                    <small class="muted" data-filetypesextensions=".gtar">
                        .gtar
                    </small>
                </label>
            </li>
            <li data-filetypesbrowserkey=".gz" style="margin-left: 2em" role="treeitem">
                <label>
                    <input data-filetypesbrowserkey=".gz" type="checkbox">
                    <span data-filetypesname=".gz">Archive (GZ)</span>
                    <small class="muted" data-filetypesextensions=".gz">
                        .gz
                    </small>
                </label>
            </li>
            <li data-filetypesbrowserkey=".gzip" style="margin-left: 2em" role="treeitem">
                <label>
                    <input data-filetypesbrowserkey=".gzip" type="checkbox">
                    <span data-filetypesname=".gzip">Archive (GZIP)</span>
                    <small class="muted" data-filetypesextensions=".gzip">
                        .gzip
                    </small>
                </label>
            </li>
            <li data-filetypesbrowserkey=".hqx" style="margin-left: 2em" role="treeitem">
                <label>
                    <input data-filetypesbrowserkey=".hqx" type="checkbox">
                    <span data-filetypesname=".hqx">Archive (HQX)</span>
                    <small class="muted" data-filetypesextensions=".hqx">
                        .hqx
                    </small>
                </label>
            </li>
            <li data-filetypesbrowserkey=".rar" style="margin-left: 2em" role="treeitem">
                <label>
                    <input data-filetypesbrowserkey=".rar" type="checkbox">
                    <span data-filetypesname=".rar">Archive (RAR)</span>
                    <small class="muted" data-filetypesextensions=".rar">
                        .rar
                    </small>
                </label>
            </li>
            <li data-filetypesbrowserkey=".sit" style="margin-left: 2em" role="treeitem">
                <label>
                    <input data-filetypesbrowserkey=".sit" type="checkbox">
                    <span data-filetypesname=".sit">Archive (SIT)</span>
                    <small class="muted" data-filetypesextensions=".sit">
                        .sit
                    </small>
                </label>
            </li>
            <li data-filetypesbrowserkey=".tar" style="margin-left: 2em" role="treeitem">
                <label>
                    <input data-filetypesbrowserkey=".tar" type="checkbox">
                    <span data-filetypesname=".tar">Archive (TAR)</span>
                    <small class="muted" data-filetypesextensions=".tar">
                        .tar
                    </small>
                </label>
            </li>
            <li data-filetypesbrowserkey=".tgz" style="margin-left: 2em" role="treeitem">
                <label>
                    <input data-filetypesbrowserkey=".tgz" type="checkbox">
                    <span data-filetypesname=".tgz">Archive (TGZ)</span>
                    <small class="muted" data-filetypesextensions=".tgz">
                        .tgz
                    </small>
                </label>
            </li>
            <li data-filetypesbrowserkey=".zip" style="margin-left: 2em" role="treeitem">
                <label>
                    <input data-filetypesbrowserkey=".zip" type="checkbox">
                    <span data-filetypesname=".zip">Archive (ZIP)</span>
                    <small class="muted" data-filetypesextensions=".zip">
                        .zip
                    </small>
                </label>
            </li>
    ...
    <div data-filetypesbrowserkey="audio" role="treeitem" aria-expanded="false">
        <label>
            <input data-filetypesbrowserkey="audio" type="checkbox">
            <strong data-filetypesname="audio">Audio files</strong>
            <small class="muted" data-filetypesextensions="audio">
                .aac .aif .aiff .aifc .au .flac .m3u .mp3 .m4a .oga .ogg .ra .ram .rm .wav .wma
            </small>
        </label>
        ...
        <ul class="unstyled list-unstyled" role="group">
            <li data-filetypesbrowserkey=".aac" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".aac">Audio file (AAC)</span>
                    <small class="muted" data-filetypesextensions=".aac">
                        .aac
                    </small>
                </label>
            </li>
            <li data-filetypesbrowserkey=".aif" style="margin-left: 2em" role="treeitem">
                <label>
                    <input data-filetypesbrowserkey=".aif" type="checkbox">
                    <span data-filetypesname=".aif">Audio file (AIF)</span>
                    <small class="muted" data-filetypesextensions=".aif">
                        .aif
                    </small>
                </label>
            </li>
            <li data-filetypesbrowserkey=".aifc" style="margin-left: 2em" role="treeitem">
                <label>
                    <input data-filetypesbrowserkey=".aifc" type="checkbox">
                    <span data-filetypesname=".aifc">Audio file (AIFC)</span>
                    <small class="muted" data-filetypesextensions=".aifc">
                        .aifc
                    </small>
                </label>
            </li>
            <li data-filetypesbrowserkey=".aiff" style="margin-left: 2em" role="treeitem">
                <label>
                    <input data-filetypesbrowserkey=".aiff" type="checkbox">
                    <span data-filetypesname=".aiff">Audio file (AIFF)</span>
                    <small class="muted" data-filetypesextensions=".aiff">
                        .aiff
                    </small>
                </label>
            </li>
            <li data-filetypesbrowserkey=".au" style="margin-left: 2em" role="treeitem">
                <label>
                    <input data-filetypesbrowserkey=".au" type="checkbox">
                    <span data-filetypesname=".au">Audio file (AU)</span>
                    <small class="muted" data-filetypesextensions=".au">
                        .au
                    </small>
                </label>
            </li>
            <li data-filetypesbrowserkey=".flac" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".flac">Audio file (FLAC)</span>
                    <small class="muted" data-filetypesextensions=".flac">
                        .flac
                    </small>
                </label>
            </li>
            <li data-filetypesbrowserkey=".m3u" style="margin-left: 2em" role="treeitem">
                <label>
                    <input data-filetypesbrowserkey=".m3u" type="checkbox">
                    <span data-filetypesname=".m3u">Audio file (M3U)</span>
                    <small class="muted" data-filetypesextensions=".m3u">
                        .m3u
                    </small>
                </label>
            </li>
            <li data-filetypesbrowserkey=".m4a" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".m4a">Audio file (M4A)</span>
            ...
            <li data-filetypesbrowserkey=".mp3" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".mp3">Audio file (MP3)</span>
            ...
            <li data-filetypesbrowserkey=".oga" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".oga">Audio file (OGA)</span>
            ...
            <li data-filetypesbrowserkey=".ogg" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".ogg">Audio file (OGG)</span>
            ...
            <li data-filetypesbrowserkey=".ra" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".ra">Audio file (RA)</span>
                    <small class="muted" data-filetypesextensions=".ra">
                        .ra
                    </small>
                </label>
            </li>
            <li data-filetypesbrowserkey=".ram" style="margin-left: 2em" role="treeitem">
                <label>
                    <input data-filetypesbrowserkey=".ram" type="checkbox">
                    <span data-filetypesname=".ram">Audio file (RAM)</span>
                    <small class="muted" data-filetypesextensions=".ram">
                        .ram
                    </small>
                </label>
            </li>
            <li data-filetypesbrowserkey=".rm" style="margin-left: 2em" role="treeitem">
                <label>
                    <input data-filetypesbrowserkey=".rm" type="checkbox">
                    <span data-filetypesname=".rm">Audio file (RM)</span>
                    <small class="muted" data-filetypesextensions=".rm">
                        .rm
                    </small>
                </label>
            </li>
            <li data-filetypesbrowserkey=".wav" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".wav">Audio file (WAV)</span>
                    <small class="muted" data-filetypesextensions=".wav">
                        .wav
                    </small>
                </label>
            </li>
            <li data-filetypesbrowserkey=".wma" style="margin-left: 2em" role="treeitem">
                <label>
                    <input data-filetypesbrowserkey=".wma" type="checkbox">
                    <span data-filetypesname=".wma">Audio file (WMA)</span>
                    <small class="muted" data-filetypesextensions=".wma">
                        .wma
                    </small>
                </label>
            </li>
    ...
    <div data-filetypesbrowserkey="web_audio" role="treeitem" aria-expanded="false">
        <label>
            ...
            <strong data-filetypesname="web_audio">Audio files used on the web</strong>
    ...
    <div data-filetypesbrowserkey="document" role="treeitem" aria-expanded="false">
        <label>
            <input data-filetypesbrowserkey="document" type="checkbox">
            <strong data-filetypesname="document">Document files</strong>
            <small class="muted" data-filetypesextensions="document">
        ...
        <small aria-hidden="true" data-filetypesbrowserfeature="hideifcollapsed" class="float-right float-right"><a href="#">Collapse</a></small>
        <ul class="unstyled list-unstyled" role="group">
            <li data-filetypesbrowserkey=".gdoc" style="margin-left: 2em" role="treeitem">
                <label>
                    <input data-filetypesbrowserkey=".gdoc" type="checkbox">
                    <span data-filetypesname=".gdoc">application/vnd.google-apps.document</span>
                    <small class="muted" data-filetypesextensions=".gdoc">
                        .gdoc
                    </small>
                </label>
            </li>
            <li data-filetypesbrowserkey=".epub" style="margin-left: 2em" role="treeitem">
                <label>
                    <input data-filetypesbrowserkey=".epub" type="checkbox">
                    <span data-filetypesname=".epub">EPUB ebook</span>
                    <small class="muted" data-filetypesextensions=".epub">
                        .epub
                    </small>
                </label>
            </li>
            <li data-filetypesbrowserkey=".odt" style="margin-left: 2em" role="treeitem">
                <label>
                    <input data-filetypesbrowserkey=".odt" type="checkbox">
                    <span data-filetypesname=".odt">OpenDocument Text document</span>
                    <small class="muted" data-filetypesextensions=".odt">
                        .odt
                    </small>
                </label>
            </li>
            <li data-filetypesbrowserkey=".ott" style="margin-left: 2em" role="treeitem">
                <label>
                    <input data-filetypesbrowserkey=".ott" type="checkbox">
                    <span data-filetypesname=".ott">OpenDocument Text template</span>
                    <small class="muted" data-filetypesextensions=".ott">
                        .ott
                    </small>
                </label>
            </li>
            <li data-filetypesbrowserkey=".oth" style="margin-left: 2em" role="treeitem">
                <label>
                    <input data-filetypesbrowserkey=".oth" type="checkbox">
                    <span data-filetypesname=".oth">OpenDocument Web page template</span>
                    <small class="muted" data-filetypesextensions=".oth">
                        .oth
                    </small>
                </label>
            </li>
            <li data-filetypesbrowserkey=".pdf" style="margin-left: 2em" role="treeitem">
                <label>
                    <input data-filetypesbrowserkey=".pdf" type="checkbox">
                    <span data-filetypesname=".pdf">PDF document</span>
                    <small class="muted" data-filetypesextensions=".pdf">
                        .pdf
                    </small>
                </label>
            </li>
            <li data-filetypesbrowserkey=".rtf" style="margin-left: 2em" role="treeitem">
                <label>
                    <input data-filetypesbrowserkey=".rtf" type="checkbox">
                    <span data-filetypesname=".rtf">RTF document</span>
                    <small class="muted" data-filetypesextensions=".rtf">
                        .rtf
                    </small>
                </label>
            </li>
            <li data-filetypesbrowserkey=".docx" style="margin-left: 2em" role="treeitem">
                <label>
                    <input data-filetypesbrowserkey=".docx" type="checkbox">
                    <span data-filetypesname=".docx">Word 2007 document</span>
                    <small class="muted" data-filetypesextensions=".docx">
                        .docx
                    </small>
                </label>
            </li>
            <li data-filetypesbrowserkey=".doc" style="margin-left: 2em" role="treeitem">
                <label>
                    <input data-filetypesbrowserkey=".doc" type="checkbox">
                    <span data-filetypesname=".doc">Word document</span>
                    <small class="muted" data-filetypesextensions=".doc">
                        .doc
                    </small>
                </label>
            </li>
    ...
    <div data-filetypesbrowserkey="html_track" role="treeitem" aria-expanded="false">
        <label>
            <input data-filetypesbrowserkey="html_track" type="checkbox">
            <strong data-filetypesname="html_track">HTML track files</strong>
            <small class="muted" data-filetypesextensions="html_track">
                .vtt
            </small>
        </label>
        ...
        <small aria-hidden="true" data-filetypesbrowserfeature="hideifcollapsed" class="float-right float-right"><a href="#">Collapse</a></small>
        <ul class="unstyled list-unstyled" role="group">
            <li data-filetypesbrowserkey=".vtt" style="margin-left: 2em" role="treeitem">
                <label>
                    <input data-filetypesbrowserkey=".vtt" type="checkbox">
                    <span data-filetypesname=".vtt">Web Video Text Track</span>
                    <small class="muted" data-filetypesextensions=".vtt">
                        .vtt
                    </small>
                </label>
            </li>
    ...
    <div data-filetypesbrowserkey="image" role="treeitem" aria-expanded="false">
        <label>
            ...
            <strong data-filetypesname="image">Image files</strong>
        ...
        <ul class="unstyled list-unstyled" role="group">
            ...
            <li data-filetypesbrowserkey=".bmp" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".bmp">Image (BMP)</span>
            ...
            <li data-filetypesbrowserkey=".gif" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".gif">Image (GIF)</span>
            ...
            <li data-filetypesbrowserkey=".jpe" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".jpe">Image (JPEG)</span>
            ...
            <li data-filetypesbrowserkey=".jpeg" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".jpeg">Image (JPEG)</span>
            ...
            <li data-filetypesbrowserkey=".jpg" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".jpg">Image (JPEG)</span>
            ...
            <li data-filetypesbrowserkey=".pct" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".pct">Image (PICT)</span>
            ...
            <li data-filetypesbrowserkey=".pic" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".pic">Image (PICT)</span>
            ...
            <li data-filetypesbrowserkey=".pict" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".pict">Image (PICT)</span>
            ...
            <li data-filetypesbrowserkey=".png" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".png">Image (PNG)</span>
            ...
            <li data-filetypesbrowserkey=".ai" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".ai">Image (POSTSCRIPT)</span>
            ...
            <li data-filetypesbrowserkey=".svg" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".svg">Image (SVG+XML)</span>
            ...
            <li data-filetypesbrowserkey=".svgz" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".svgz">Image (SVG+XML)</span>
            ...
            <li data-filetypesbrowserkey=".tif" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".tif">Image (TIFF)</span>
            ...
            <li data-filetypesbrowserkey=".tiff" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".tiff">Image (TIFF)</span>
            ...
            <li data-filetypesbrowserkey=".ico" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".ico">Windows icon</span>
    ...
    <div data-filetypesbrowserkey="optimised_image" role="treeitem" aria-expanded="false">
        <label>
            <input data-filetypesbrowserkey="optimised_image" type="checkbox">
            <strong data-filetypesname="optimised_image">Image files to be optimised, such as badges</strong>
            <small class="muted" data-filetypesextensions="optimised_image">
    ...
    <div data-filetypesbrowserkey="web_image" role="treeitem" aria-expanded="false">
        <label>
            ...
            <strong data-filetypesname="web_image">Image files used on the web</strong>
    ...
    <div data-filetypesbrowserkey="presentation" role="treeitem" aria-expanded="false">
        <label>
            ...
            <strong data-filetypesname="presentation">Presentation files</strong>
        ...
        <ul class="unstyled list-unstyled" role="group">
            ...
            <li data-filetypesbrowserkey=".pptx" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".pptx">Powerpoint 2007 presentation</span>
            ...
            <li data-filetypesbrowserkey=".ppsx" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".ppsx">Powerpoint 2007 slideshow</span>
            ...
            <li data-filetypesbrowserkey=".pps" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".pps">Powerpoint presentation</span>
            ...
            <li data-filetypesbrowserkey=".ppt" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".ppt">Powerpoint presentation</span>
    ...
    <div data-filetypesbrowserkey="spreadsheet" role="treeitem" aria-expanded="false">
        <label>
            ...
            <strong data-filetypesname="spreadsheet">Spreadsheet files</strong>
        ...
        <ul class="unstyled list-unstyled" role="group">
            ...
            <li data-filetypesbrowserkey=".csv" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".csv">Comma-separated values</span>
            ...
            <li data-filetypesbrowserkey=".xlsx" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".xlsx">Excel 2007 spreadsheet</span>
            ...
            <li data-filetypesbrowserkey=".xls" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".xls">Excel spreadsheet</span>
    ...
    <div data-filetypesbrowserkey="media_source" role="treeitem" aria-expanded="false">
        <label>
            <input data-filetypesbrowserkey="media_source" type="checkbox">
            <strong data-filetypesname="media_source">Streaming media</strong>
            <small class="muted" data-filetypesextensions="media_source">
                .m3u8 .mpd
            </small>
        </label>
        ...
        <small aria-hidden="true" data-filetypesbrowserfeature="hideifcollapsed" class="float-right float-right"><a href="#">Collapse</a></small>
        <ul class="unstyled list-unstyled" role="group">
            <li data-filetypesbrowserkey=".mpd" style="margin-left: 2em" role="treeitem">
                <label>
                    <input data-filetypesbrowserkey=".mpd" type="checkbox">
                    <span data-filetypesname=".mpd">Dynamic Adaptive Streaming over HTTP (MPEG-DASH)</span>
                    <small class="muted" data-filetypesextensions=".mpd">
                        .mpd
                    </small>
                </label>
            </li>
            <li data-filetypesbrowserkey=".m3u8" style="margin-left: 2em" role="treeitem">
                <label>
                    <input data-filetypesbrowserkey=".m3u8" type="checkbox">
                    <span data-filetypesname=".m3u8">HTTP Live Streaming (HLS)</span>
                    <small class="muted" data-filetypesextensions=".m3u8">
                        .m3u8
                    </small>
                </label>
            </li>
    ...
    <div data-filetypesbrowserkey="video" role="treeitem" aria-expanded="false">
        <label>
            ...
            <strong data-filetypesname="video">Video files</strong>
        ...
        <ul class="unstyled list-unstyled" role="group">
            <li data-filetypesbrowserkey=".swfl" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".swfl">Flash animation</span>
            ...
            <li data-filetypesbrowserkey=".swf" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".swf">Flash animation</span>
            ...
            <li data-filetypesbrowserkey=".3gp" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".3gp">Video file (3GP)</span>
            ...
            <li data-filetypesbrowserkey=".asf" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".asf">Video file (ASF)</span>
            ...
            <li data-filetypesbrowserkey=".avi" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".avi">Video file (AVI)</span>
            ...
            <li data-filetypesbrowserkey=".dif" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".dif">Video file (DIF)</span>
            ...
            <li data-filetypesbrowserkey=".dv" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".dv">Video file (DV)</span>
            ...
            <li data-filetypesbrowserkey=".f4v" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".f4v">Video file (F4V)</span>
            ...
            <li data-filetypesbrowserkey=".flv" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".flv">Video file (FLV)</span>
            ...
            <li data-filetypesbrowserkey=".fmp4" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".fmp4">Video file (FMP4)</span>
            ...
            <li data-filetypesbrowserkey=".m4v" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".m4v">Video file (M4V)</span>
            ...
            <li data-filetypesbrowserkey=".mov" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".mov">Video file (MOV)</span>
            ...
            <li data-filetypesbrowserkey=".movie" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".movie">Video file (MOVIE)</span>
            ...
            <li data-filetypesbrowserkey=".mp4" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".mp4">Video file (MP4)</span>
            ...
            <li data-filetypesbrowserkey=".mpe" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".mpe">Video file (MPE)</span>
            ...
            <li data-filetypesbrowserkey=".mpeg" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".mpeg">Video file (MPEG)</span>
            ...
            <li data-filetypesbrowserkey=".mpg" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".mpg">Video file (MPG)</span>
            ...
            <li data-filetypesbrowserkey=".ogv" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".ogv">Video file (OGV)</span>
            ...
            <li data-filetypesbrowserkey=".qt" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".qt">Video file (QT)</span>
            ...
            <li data-filetypesbrowserkey=".rmvb" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".rmvb">Video file (RMVB)</span>
            ...
            <li data-filetypesbrowserkey=".rv" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".rv">Video file (RV)</span>
            ...
            <li data-filetypesbrowserkey=".ts" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".ts">Video file (TS)</span>
            ...
            <li data-filetypesbrowserkey=".webm" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".webm">Video file (WEBM)</span>
            ...
            <li data-filetypesbrowserkey=".wmv" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".wmv">Video file (WMV)</span>
    ...
    <div data-filetypesbrowserkey="html_video" role="treeitem" aria-expanded="false">
        <label>
            <input data-filetypesbrowserkey="html_video" type="checkbox">
            <strong data-filetypesname="html_video">Video files natively supported by browsers</strong>
            <small class="muted" data-filetypesextensions="html_video">
                .fmp4 .mov .mp4 .m4v .ogv .webm
            </small>
        </label>
    ...
    <div data-filetypesbrowserkey="web_video" role="treeitem" aria-expanded="false">
        <label>
            <input data-filetypesbrowserkey="web_video" type="checkbox">
            <strong data-filetypesname="web_video">Video files used on the web</strong>
            <small class="muted" data-filetypesextensions="web_video">
                .avi .flv .f4v .fmp4 .mov .mp4 .m4v .mpeg .mpe .mpg .ogv .qt .swf .swfl .ts .webm
            </small>
        </label>
    ...
    <div data-filetypesbrowserkey="web_file" role="treeitem" aria-expanded="false">
        <label>
            ...
            <strong data-filetypesname="web_file">Web files</strong>
        ...
        <ul class="unstyled list-unstyled" role="group">
            ...
            <li data-filetypesbrowserkey=".html" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".html">HTML document</span>
            ...
            <li data-filetypesbrowserkey=".htm" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".htm">HTML document</span>
            ...
            <li data-filetypesbrowserkey=".js" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".js">JavaScript source</span>
            ...
            <li data-filetypesbrowserkey=".xhtml" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".xhtml">XHTML document</span>
        ...
        <ul class="unstyled list-unstyled" role="group">
            ...
            <li data-filetypesbrowserkey=".h5p" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".h5p">Archive (H5P)</span>
            ...
            <li data-filetypesbrowserkey=".xltx" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".xltx">Excel 2007 template</span>
            ...
            <li data-filetypesbrowserkey=".mbz" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".mbz">Moodle backup</span>
            ...
            <li data-filetypesbrowserkey=".txt" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".txt">Text file</span>
            ...
            <li data-filetypesbrowserkey=".cpp" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".cpp">Text file</span>
            ...
            <li data-filetypesbrowserkey=".asm" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".asm">Text file</span>
            ...
            <li data-filetypesbrowserkey=".h" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".h">Text file</span>
            ...
            <li data-filetypesbrowserkey=".php" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".php">Text file</span>
            ...
            <li data-filetypesbrowserkey=".asc" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".asc">Text file</span>
            ...
            <li data-filetypesbrowserkey=".applescript" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".applescript">Text file</span>
            ...
            <li data-filetypesbrowserkey=".m" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".m">Text file</span>
            ...
            <li data-filetypesbrowserkey=".hpp" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".hpp">Text file</span>
            ...
            <li data-filetypesbrowserkey=".c" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".c">Text file</span>
            ...
            <li data-filetypesbrowserkey=".java" style="margin-left: 2em" role="treeitem">
                <label>
                    ...
                    <span data-filetypesname=".java">Text file</span>

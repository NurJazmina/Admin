  ...
  <table class="table table-bordered table-sm" style="text-align:center;">
    ...
    <tbody>
      ...
      foreach ($cursor as $document)
      {
        ...
        <td>
          <button style="font-size:10px" type="button" class="btn btn-light btn-hover-success" data-bs-toggle="modal" data-bs-target="#EditDepartmentModal" data-bs-whatever="<?php echo $departmentid; ?>">
            <i class="fa fa-edit" style="font-size:15px"></i>
          </button>
          <button style="font-size:10px" type="button" class="btn btn-light btn-hover-success" data-bs-toggle="modal" data-bs-target="#DeleteDepartmentModal" data-bs-whatever="<?php echo $departmentid; ?>">
      ...
      <tr style="background-color:#ffffff;">
        <th scope="row">Add</th>
        <td colspan="2">
          <button style="font-size:10px" type="button"  class="btn btn-light btn-hover-success" data-bs-toggle="modal" data-bs-target="#AddDepartmentModal">
...
<?php 
include ('view/pages/modal-departmentlist.php'); 
?>
    ...
    foreach ($cursor as $document)
    {
      ...
      if($ConsumerGroup_id == '6018c2ebc8c7c7b2e8a4140c')
      {
        ...
        if ($parentconsumerid == $ParentConsumerid)
        {
          ...
          {
            ?>
            <form id="addrelationstudent" name="addrelationstudent" action="index.php?page=duplicateforparentlist" method="post" style="padding-top: 10em;">
          ...
          {
            ?>
            <form id="addrelation" name="addrelation" action="index.php?page=duplicateforparentlist" method="post" style="padding-top: 10em;">
              <div class="modal-dialog modal-lg modal-dialog-centered">
              <div class="modal-content">
                  <div class="alert alert-danger" role="alert">
        ...
        else
        {
            ...
            <form id="submitaddparent" name="submitaddparent" action="index.php?page=parentlist" method="post">
              ...
              <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="AddParentModalLabel">Add Parent and Student</h5>
                    </div>
                    <div class="modal-body">
                      <div class="form-group row">
          ...
          {
            ?>
            <form id="addrelationparent" name="addrelationparent" action="index.php?page=duplicateforparentlist" method="post" style="padding-top: 10em;">
              <div class="modal-dialog modal-lg modal-dialog-centered">
              <div class="modal-content">
                  <div class="alert alert-danger" role="alert">

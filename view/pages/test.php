...
<div class="main">
  ...
  <form class="form1" name="login" method="post" action="index.php?page=test">
    ...
    <button class="submit" id="login" align="center" name="login">Sign in</button>
...
<form class="form bg-white" name="Adddata" method="post" action="index.php?page=test">
    <input  type="text" align="center" id="txtID" name="txtID" placeholder="Your ID">
    <input  type="password" align="center" id="txtPassword" name="txtPassword" placeholder="Password" >
    <button  id="login" align="center" name="Adddata">Sign in</button>
</form>

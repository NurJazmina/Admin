...
<div><h1 style="color:#696969; text-align:center">Forums</h1></div><br>
<div class="row">
    <div class="col-9">
    <?php
            ...
            <div class="card-body">
                <div class="table-responsive-sm" style="line-height: 100%;">
                    ...
                    foreach ($cursor as $document)
                    {
                        ...
                        ?>
                        <a style="text-decoration: none; font-size: 15px;" href="index.php?page=schoolforumdetail&forum=1&topic=general&id=<?php echo $Forumid; ?>"><?php echo $ForumTitle."<br>"; ?></a>
                        <br>
                        <!--listbox-->
                        <div id="listbox" style="letter-spacing: 1px;">
                            <small style="color:#687a86;"><?php echo $ConsumerFName; ?></small>
                            <span class="fff">|</span>
                            <small style="color:#687a86;"><?php echo date_format($datetime,"d/m/y"); echo " ( ".time_elapsed($nowtime-$oldtime)." ) \n"; ?></small>
                            <span class="fff">|</span>
                            <small style="color:#687a86;">Commenting : <?php echo $total; ?></small>
                        </div>
                        <br>
                        <?php
                    }
                    ...
                    foreach ($cursor as $document)
                    {
                        ...
                        ?>
                        <a style="text-decoration: none;" href="index.php?page=schoolforumdetail&forum=1&topic=general&id=<?php echo $Forumid; ?>"><?php echo $ForumTitle."<br>"; ?></a>
                        <br>
                        <!--listbox-->
                        <div id="listbox" style="letter-spacing: 1px;">
                            <small style="color:#687a86;"><?php echo $ConsumerFName; ?></small>
            ...
            <div class="card-body">
                <div class="table-responsive-sm" style="line-height: 100%;">
                    ...
                    foreach ($cursor as $document)
                    {
                        ...
                        ?>
                        <a style="text-decoration: none;" href="index.php?page=publicforumdetail&forum=1&topic=general&id=<?php echo $Forumid; ?>"><?php echo $ForumTitle."<br>"; ?></a>
                        <br>
                        <!--listbox-->
                        <div id="listbox" style="letter-spacing: 1px;">
                            <small style="color:#687a86;"><?php echo $ConsumerFName; ?></small>

...
<div class="row">
	<div class="col">
		<div class="card card-custom gutter-b">
			...
			<div class="card-body">
				...
				<div class="d-flex justify-content-between flex-column h-100">
					...
					<!--eng::Container-->
					<!--begin::Footer-->
					<button class="btn btn-success btn-hover-light btn-sm" data-toggle="modal" data-target="#kt_chat_modal">Contact School</button>
					<!--end::Footer-->
				</div>
				<!--end::Wrapper-->
			</div>
		...
		<div class="card card-custom gutter-b" id="construction">
			<div id="uc__wrapper">
				<div id="uc__details">
					<h1>Coming Soon!</h1>
					...
					<p id="uc__description">
						Features
						<span class="svg-icon svg-icon-light svg-icon-1x">

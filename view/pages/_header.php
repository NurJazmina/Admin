			...
			<div class="dropdown">
				<div class="topbar-item" data-toggle="dropdown" data-offset="0px,0px">
					<div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
						...
						<span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3"><?= $_SESSION["loggeduser_consumerFName"]; ?></span>
						<?php
						$name = $_SESSION["loggeduser_consumerFName"];
						$firstCharacter = $name[0];
						?>
						<span class="symbol symbol-lg-35 symbol-25 symbol-success">
							<span class="symbol-label font-size-h5 font-weight-bold" style="color:#ffffff;"><?= $firstCharacter; ?></span>
						</span>
					</div>
				</div>

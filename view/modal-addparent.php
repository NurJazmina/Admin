...
<form id="AddParentFormSubmit" name="AddParentFormSubmit" action="index.php?page=addparent" method="post">
  <div class="modal fade" id="recheckparent" tabindex="-1" aria-labelledby="AddParentModalLabel" aria-hidden="true">

<br><br><form name="UpdateStudentFormSubmit" action="index.php?page=studentlist" method="post">
  <div class="modal fade" id="UpdateStudentModal" tabindex="-1" aria-labelledby="UpdateStudentodalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-secondary" name="UpdateStudentFormSubmit">Confirm</button>
        </div>
    </div>
  </div>
</div>

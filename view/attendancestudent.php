...
<div class="myDiv" style="color:#696969;text-align:center">
      <br><br><br><h1>Attendance Student : <?php echo $ConsumerFName; echo " "; echo $ConsumerLName;?></h1>
</div>
<br>
              ...
              <tbody>
                ...
                <td>  
                  <table>
                    ...
                    $cursorA = $GoNGetzBackEnd->executeQuery('GoNGetzSmartSchool.Attendance',$queryA);

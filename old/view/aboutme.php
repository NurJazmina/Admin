                  ...
                  <div class="col-sm-12">
                    <div class="tab-content" id="v-pills-tabContent">
                      <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                        <div class="box">
                        <form name="AddStaffRemarkFormSubmit" action="index.php?page=aboutme" method="POST">
                          <div class="row">
                            <div class="col">
                          ...
                          <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="active" role="tabpanel" aria-labelledby="active-tab">
                              <div class="table-responsive">
                                ...
                                <?php
                                $filter2 = ['Consumer_id'=>$_SESSION["loggeduser_id"],'SubRemarks'=>'0','ConsumerRemarksStatus'=>'ACTIVE'];
                                ...
                                foreach ($cursor2 as $document2)
                                {
                                  ...
                                  ?>
                                    ...
                                    <div class="accordion-item" >
                                      ...
                                      <?php 
                                      $filter4 = ['Consumer_id'=>$_SESSION["loggeduser_id"],'SubRemarks'=>$_SESSION["staffremarkidparent"],'ConsumerRemarksStatus'=>'ACTIVE'];
                            ...
                            <div class="tab-pane fade show pending" id="pending" role="tabpanel" aria-labelledby="pending-tab">
                              <div class="table-responsive">
                                ...
                                <?php
                                $filter2 = ['Consumer_id'=>$_SESSION["loggeduser_id"],'SubRemarks'=>'0','ConsumerRemarksStatus'=>'PENDING'];
                                $option2 = ['sort' => ['_id' => -1],'limit'=>10];
                                $query2 = new MongoDB\Driver\Query($filter2, $option2);
                                $cursor2 = $GoNGetzDatabase->executeQuery('GoNGetzSmartSchool.StaffRemarks',$query2);
                                ...
                                foreach ($cursor2 as $document2)
                                {
                                  ...
                                  ?>
                                    ...
                                    <div class="accordion-item" >
                                      ...
                                      <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                      <?php 
                                      $filter4 = ['Consumer_id'=>$_SESSION["loggeduser_id"],'SubRemarks'=>$_SESSION["staffremarkidparent"],'ConsumerRemarksStatus'=>'PENDING'];
                                      $option4 = ['sort' => ['_id' => -1],'limit'=>10];
                                      $query4 = new MongoDB\Driver\Query($filter4, $option4);
                                      $cursor4 = $GoNGetzDatabase->executeQuery('GoNGetzSmartSchool.StaffRemarks',$query4);
                                      foreach ($cursor4 as $document4)
                            ...
                            <div class="tab-pane fade show completed" id="completed" role="tabpanel" aria-labelledby="completed-tab">
                              <div class="table-responsive">
                                ...
                                <?php
                                $filter2 = ['Consumer_id'=>$_SESSION["loggeduser_id"],'SubRemarks'=>'0','ConsumerRemarksStatus'=>'COMPLETED'];
                                $option2 = ['sort' => ['_id' => -1],'limit'=>10];
                                $query2 = new MongoDB\Driver\Query($filter2, $option2);
                                $cursor2 = $GoNGetzDatabase->executeQuery('GoNGetzSmartSchool.StaffRemarks',$query2);
                                ...
                                foreach ($cursor2 as $document2)
                                {
                                  ...
                                  ?>
                                    ...
                                    <div class="accordion-item" >
                                      ...
                                      <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                      <?php 
                                      $filter4 = ['Consumer_id'=>$_SESSION["loggeduser_id"],'SubRemarks'=>$_SESSION["staffremarkidparent"],'ConsumerRemarksStatus'=>'COMPLETED'];
                                      $option4 = ['sort' => ['_id' => -1],'limit'=>10];
                                      $query4 = new MongoDB\Driver\Query($filter4, $option4);
                                      $cursor4 = $GoNGetzDatabase->executeQuery('GoNGetzSmartSchool.StaffRemarks',$query4);
                                      foreach ($cursor4 as $document4)

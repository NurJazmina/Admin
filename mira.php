...
foreach ($cursor2 as $document2)
{
    ...
    echo $ConsumerGroupName.$_SESSION["loggeduser_StaffLevel"];
}

$filter1 = ['SchoolNewsStatus'=>'ACTIVE'];
$option1 = ['limit'=>100,'sort' => ['_id' => -1]];
...
{
  $filterB = ['SchoolNewsAccess'=>$ConsumerGroupName.$_SESSION["loggeduser_StaffLevel"]];
...
{
  $filterC = ['SchoolNewsAccess'=>$ConsumerGroupName.$_SESSION["loggeduser_StaffLevel"]];
